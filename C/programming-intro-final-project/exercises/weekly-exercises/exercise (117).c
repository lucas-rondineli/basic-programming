/*
Faça um programa para consultar o número, nome e média de
...
int main(int argc, char **argv)
{
    ...
    // Teste se existe algum aluno que cumpra o requisito de média maior ou igual a 7
    // Caso não haja nenhum, sai do programa
    tStudent student;
    int i = 0;
    for (i; i < totalInFile; i++)
    {
        ...
        if ((student.grade1 + student.grade2) / 2 >= 7)
            break;
    }
    if (i == totalInFile)
    {
